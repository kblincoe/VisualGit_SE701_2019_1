              ...
              <ul class="dropdown-menu" id="branch-dropdown" role="menu" aria-labelledby="branch-name">
                <li role="presentation" id="create-branch">
                  <div class="input-group menuitem">
                    <input type="text" id="branchName" onkeyup="sortBranches(); checkBranch(this)" class="form-control"
                      placeholder="Search or create branch">
                    <span class="input-group-btn">
                      <button class="btn btn-default masterTooltip" id = "branch-btn" type="button" disabled="disabled"
                      onclick="createBranch(this)" title="Must meet Git branch standards">OK</button>
                    </span>
                  </div>
                </li>
              </ul>
          ...
          <ul class="nav navbar-nav visible-xs">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" id="branch-dropdown" role="menu" aria-labelledby="branch-name" style="margin: 5px 20px">
                <li role="presentation" id="create-branch">
                  <div class="input-group menuitem">
                    <input type="text" id="branchName2" onkeyup="sortBranches(); checkBranch(this)" class="form-control"
                      placeholder="Search or create branch">
                    <span class="input-group-btn">
                      <button class="btn btn-default masterTooltip" id = "branch-btn2" type="button" disabled="disabled"
                        title="Must meet Git branch standards" onclick="createBranch(this)">OK</button>
                    </span>
                  </div>
                </li>
              </ul>
